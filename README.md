[![Build Status](https://travis-ci.org/postoldster/js-assignments.svg?branch=master)](https://travis-ci.org/postoldster/js-assignments)
![Hackage-Deps](https://img.shields.io/hackage-deps/v/lens.svg)
[![Greenkeeper badge](https://badges.greenkeeper.io/postoldster/js-assignments.svg)](https://greenkeeper.io/)
[![GitHub release](https://img.shields.io/github/release/postoldster/js-assignments.svg)](https://github.com/postoldster/js-assignments/releases/latest)
...
* Edit local README.md file and update all links (just replace all occurrences of `'postoldster'` with your account name).
...
```
* Open https://github.com/postoldster/js-assignments and test the build icon. Now it will run all tests and update status once you push changes to github. Keep this icon green!
...
* Push your updates to github server and check if tests passed on [travis-ci](https://travis-ci.org/postoldster/js-assignments/builds).
